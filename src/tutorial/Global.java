...
public class Global {
    ...
    public boolean runCode(String program, QA qa) {
        try {
            ...
            coc.start();
            //program="public class MainClass{public static void main(){System.out.print(2);}}";    
            javaCodeRunner.runCode(program);
            String res1=coc.stop();            
            System.out.println("Res1 = " + res1);
            coc.start();            
            javaCodeRunner.runCode(qa.getCode().replace("'", "\""));
            String res2=coc.stop();
            System.out.println("Res2 = " + res2);
            boolean val = res1.trim().equals(res2.trim());
            /*if (val) {
